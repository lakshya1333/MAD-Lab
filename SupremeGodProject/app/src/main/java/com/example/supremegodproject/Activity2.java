...
public class Activity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvHeader.setText("ACTIVITY 2");

        // Spinner Setup
        String[] items = {"Option X", "Option Y", "Option Z"};
        ...
        btnInsert.setOnClickListener(v -> {
            boolean isInserted = dbHelper.insertData(etName.getText().toString(), etValue1.getText().toString(), "Act2", "Act2");
            Toast.makeText(this, isInserted ? "Inserted" : "Failed", Toast.LENGTH_SHORT).show();
        });

        // Update
        btnUpdate.setOnClickListener(v -> {
            int rows = dbHelper.updateData(etID.getText().toString(), etName.getText().toString(), etValue1.getText().toString(), "U2", "U2");
        ...
        // Navigation
        btnNext.setOnClickListener(v -> startActivity(new Intent(this, Activity3.class)));
