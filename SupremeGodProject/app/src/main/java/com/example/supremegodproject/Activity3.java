...
public class Activity3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnInsert.setOnClickListener(v -> {
            boolean isInserted = dbHelper.insertData(etName.getText().toString(), etValue1.getText().toString(), "Act3", "Act3");
            Toast.makeText(this, isInserted ? "Inserted" : "Failed", Toast.LENGTH_SHORT).show();
        });

        // Update
        btnUpdate.setOnClickListener(v -> {
            int rows = dbHelper.updateData(etID.getText().toString(), etName.getText().toString(), etValue1.getText().toString(), "U3", "U3");
        ...
        btnNext.setOnClickListener(v -> {
            // To reduce activities, simply comment out or delete this block
